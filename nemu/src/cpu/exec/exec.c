...
make_group(gp5,
    EMPTY, EMPTY, EMPTY, EMPTY,
    EMPTY, EMPTY, IDEXW(r,push,4), EMPTY)
...
opcode_entry opcode_table [512] = {
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G,movzx,2), IDEXW(mov_E2G,movzx,4),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEXW(mov_E2G,movsx,2), IDEXW(mov_E2G,movsx,4),
